...
class Product extends Model
{
    ...
    {
        return $this->belongsToMany(Color::class, 'product_colors')->withPivot('price', 'code', 'quantity', 'product_id', 'image');
    }
    ...
    {
        return $this->belongsToMany(Size::class, 'product_sizes')->withPivot('price', 'code', 'quantity','product_id');
    }
    ...
    public static function getDiscountPercentage($price, $discountPrice)
    {
        ...
        // If price is zero, avoid division by zero
        if ($price == 0) {
            return 0;
        }
