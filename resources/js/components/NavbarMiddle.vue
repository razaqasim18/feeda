<template>
    <div class="main-container py-2 flex items-center justify-between gap-8">
        ...
        <div class="flex items-center gap-8 grow">
            <!-- w-[130px] md:w-[180px] lg:w-[240px] -->
            <router-link to="/" class="max-w-[200px] max-h-[150px]">
                <!-- <img :src="master.logo" alt="Logo" class="sm:h-[50px] sm:w-[100%] md:h-[50px] md:w-[100px]" /> -->

                <img :src="master.logo" alt="Logo" />


                <!-- <h2 class="text-[19px] md:text-[25px] font-semibold leading-tight text-primary-700"> {{ master . appName }}</h2> -->
            </router-link>
            <div
                class="relative overflow-hidden grow max-w-[800px] hidden md:block rounded-full border border-slate-200">
                <input type="text" v-model="search" :placeholder="$t('Search product')"
                    class="px-5 py-1.5 block w-full rounded-full outline-none placeholder:text-gray-400 text-base font-normal leading-normal border-none focus:ring-0"
                    @keyup.enter="searchProducts()">
                <button class="bg-primary-600 h-full w-14 absolute top-0 flex items-center justify-center rounded-full"
                    :class="master.langDirection == 'rtl' ? 'left-0' : 'right-0'" @click="searchProducts()">
                                        ...
                                        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl p-4">
                                            ...
                                            <div class="justify-start inline-flex grow flex-col mt-5 gap-2">
                                                ...
                                                <Popover class="relative">
                                                    <PopoverButton
                                                        class="block w-full py-2 px-0 border-b-2 border-slate-200 
                                                            text-left font-normal text-slate-600 
                                                    ...
                                                    >
                                                        <PopoverPanel
                                                            class="absolute left-1/2 top-full mt-2 -translate-x-1/2 z-50
                                                                bg-white shadow-xl w-[90vw] max-w-7xl rounded-xl"
                                                        >
                                                            <div
                                                ...
                                                <router-link v-if="seasonDiscount"
