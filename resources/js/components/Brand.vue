<template>
    <div class="main-container mt-6 mb-8">
        ...
        <div class="mt-8" :dir="master.langDirection || 'ltr'">
            ...
            <swiper :breakpoints="breakpoints" :loop="true"
                ...
                @swiper="onSwiper" :modules="[Navigation, Autoplay]">
                <swiper-slide v-if="!isLoading" v-for="brand in brands" :key="brand.id">
...
<script setup>
    ...
    import {
        Navigation,
        Autoplay
    } from 'swiper/modules'; // <-- include Autoplay
