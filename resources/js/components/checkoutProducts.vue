<template>
  <div class="space-y-4 mt-3 transition duration-300">
    <div v-for="shopProduct in basketStore.checkoutProducts" :key="shopProduct.shop_id"
      ...
      <div class="space-y-2 divide-y divide-slate-200">
        <!-- item 1-->
        <div v-for="product in shopProduct.products" :key="product.id"
          ...
          <div class="flex flex-col gap-1 w-full">
            ...
            <div class="flex flex-wrap justify-between items-center gap-3">
              ...
              <div class="flex items-center gap-1">
                <div class="min-w-8 text-center px-2 py-1 bg-slate-100 rounded text-slate-800 text-xs font-normal">
                  {{ product.size?.name }}
                </div>
