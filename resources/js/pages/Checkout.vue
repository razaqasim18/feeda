<template>
    <div class="main-container">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 my-3 gap-8">
            ...
            <div class="col-span-1 xl:col-span-2">
                ...
                <div class="mt-6">
                    <div>
                        ...
                        <select v-model="area"
                            class="w-full mt-1 p-3 rounded bg-transparent border border-gray-300 outline-none focus:border-slate-400">
                            
                            <option value="الضفة-15">
                                {{ $t('الضفة') + ' - ' + masterStore.showCurrency(15) }}
                            </option>

                            <option value="القدس-30">
                                {{ $t('القدس') + ' - ' + masterStore.showCurrency(30) }}
                            </option>

                            <option value="الداخل-65">
                                {{ $t('الداخل') + ' - ' + masterStore.showCurrency(65) }}
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <textarea v-model="note" rows="3" class="form-input" :placeholder="$t('Write your note') + '...'"></textarea>
                </div>
                ...
                <div class="p-6 mt-4 bg-white rounded-2xl border border-slate-200">
                    ...
                    <div class="mt-4 flex flex-wrap gap-4">
                        ...
                        <label for="cash" class="flex items-center gap-4 xl:min-w-80">
                            ...
                            <span
                                class="text-slate-500 text-base font-normal leading-normal">{{ $t('Cash on delivery') }}</span>
                        </label>
            ...
            <!-- Order Summary -->
            <CheckoutOrderSummary :note="note" :area="area" :paymentMethod="paymentMethod" />
