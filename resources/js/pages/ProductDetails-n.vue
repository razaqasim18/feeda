                    ...
                    <div class="lg:w-[480px] w-full">
                        <div class="w-full">
                            <div class="bg-slate-50 rounded-xl border border-slate-100 px-6">
                                ...
                                <swiper v-if="showcolordiv" :spaceBetween="10" :thumbs="{ swiper: thumbsSwiper }" :modules="modules"
                                    class="product-details-slider">
                                    <swiper-slide class="max-h-[448px] h-auto">
                                        <div  class="zoom-container h-full"
                                ...
                                <swiper v-else :spaceBetween="10" :thumbs="{ swiper: thumbsSwiper }" :modules="modules"
                                    class="product-details-slider">
                            ...
                            <div class="px-1 mt-2">
                                <swiper @swiper="setThumbsSwiper" :spaceBetween="10" :slidesPerView="4" :freeMode="true"
                                    ...
                                    <swiper-slide v-for="thumbnail in product.thumbnails" :key="thumbnail.id">
                                        <img @change="changeshowcolordiv" v-if="thumbnail.thumbnail" :src="thumbnail.thumbnail" alt=""
                                            class="h-full w-full object-cover" />

                                        <div @change="changeshowcolordiv" v-else class="h-full w-full bg-slate-200 flex justify-center items-center">
...
let showcolordiv = 0;
let selectedImage = ''; // or use `ref()` if in Composition API
...
function changeshowcolordiv(){
    console.log(showcolordiv);
    showcolordiv = 0;
    console.log(showcolordiv);
}
