<template>
    <div>
        ...
        <div class="main-container py-12">
               ...
               <!-- grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-3 sm:gap-6 items-start -->
            <div
...
const fetchProducts = async () => {
    ...
    try {
        ...
        if (response.data.data.products.length < perPage) {
