                    ...
                    <div class="col-md-6 mt-3">
                        <x-select name="taxes[]" label="Vat & Tax" placeholder="Select Vat & Tax" multiselect="true">
                            @foreach ($taxes as $tax)
                                <option value="{{ $tax->id }}"
                                    {{ in_array($tax->id, $product->vatTaxes?->pluck('id')->toArray()) ? 'selected' : '' }}>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <input type="file" class="form-control"
                                                name="color[{{ $color->id }}][cimage]" value="0"
                                                style="width: 200px">

                                            <input type="hidden" class="form-control"
                                                name="color[{{ $color->id }}][showimage]"
                                                value="{{ $color->pivot->image }}" style="width: 200px">

                                            <input type="text" name="color[{{ $color->id }}][code]"
                                                placeholder="Ex: 134543" class="form-control"
                                                value="{{ $color->pivot->code }}"
                                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" />
