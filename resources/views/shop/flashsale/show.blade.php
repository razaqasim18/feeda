                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-2 justify-content-center">
                                        ...
                                        @hasPermission('shop.flashSale.productRemove')
                                            <a href="{{ route('shop.flashSale.productRemove', ['flashSale' => $flashSale->id, 'product' => $product->id]) }}" class="btn btn-outline-danger deleteConfirm circleIcon">
            ...
            const renderSelectedProducts = () => {
                ...
                selectedProducts.forEach((product, index) => {
                    const productPrice = product.discount_price > 0 ? product.discount_price : product
                        .price;
                    var discoutPercentage = flashSale.discount / 100 * productPrice;
                    const discoutPrice = productPrice - discoutPercentage;
                    ...
                    const productCard = `
                     <div class="product-card" data-product-id="${product.id}">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <input class="product-input" type="text" name="products[${index}][discount_price]" placeholder="Discount Price" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/^(\d*\.\d{0,2}|\d*)$/, '$1');" value="${discoutPrice}"/>
                            </div>
