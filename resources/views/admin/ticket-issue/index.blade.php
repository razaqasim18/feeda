...
@section('content')
    <div class="d-flex align-items-center flex-wrap gap-3 justify-content-between px-3">
        ...
        @hasPermission('admin.ticketIssueType.create') <!--- update ticket issue route --->
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="switch mb-0">
                                        <a href="{{ route('admin.ticketIssueType.toggle', $issueType->id) }}"> <!--- update ticket issue route --->
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-3 justify-content-center">
                                        @hasPermission('admin.ticketIssueType.edit') <!--- update ticket issue route --->
                                        <button type="button" class="btn btn-outline-primary btn-sm circleIcon"
                                            onclick="openUpdateModal({{ $issueType }})">
                                            <i class="fa-solid fa-pen"></i>
                                        </button>
                                        @endhasPermission
                                        @hasPermission('admin.ticketIssueType.delete') <!--- update ticket issue route --->
                                        <a href="{{ route('admin.ticketIssueType.delete', $issueType->id) }}" class="btn btn-outline-danger btn-sm deleteConfirmAlert circleIcon"> <!--- update ticket issue route --->
